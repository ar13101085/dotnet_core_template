...
namespace KitcPPW.Migrations
{
    ...
    [Migration("20190418061402_update_file_manager")]
    partial class update_file_manager
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KitcPPW.Models.FileManager", b =>
                {
                    b.Property<long>("FileManagerId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("KitcPPW.Models.WorkOrder", b =>
                {
                    ...
                    b.HasIndex("CustomerListModelId");
            ...
            modelBuilder.Entity("KitcPPW.Models.WorkOrderPhoto", b =>
                {
                    b.Property<long>("WorkOrderPhotoId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("KitcPPW.Models.WorkOrder", b =>
                {
                    ...
                    b.HasOne("KitcPPW.Models.CustomerListModel", "CustomerListModel")
                        .WithMany()
                        .HasForeignKey("CustomerListModelId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("KitcPPW.Models.WorkOrderPhoto", b =>
                {
                    b.HasOne("KitcPPW.Models.FileManager", "File")
                        .WithMany()
